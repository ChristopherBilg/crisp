...
There is another portion of the documentation website, located at [chrisbilger.com/crisp/doc/crisp](https://chrisbilger.com/crisp/doc/crisp/), that is built from Rust's native `cargo doc` feature. That portion of the documentation is for other developers to quickly read about the Rust codebase for Crisp.
